                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-12">
                        ...
                        <div>
                            ...
                            <ul className="mt-8 space-y-4">
                                <li>
                                    <a href="#" title=""
                                       className="text-white font-semibold transition-all duration-200 hover:text-white focus:text-white"> FaceBook</a>
                                </li>
                                <li>
                                    <a href="#" title=""
                                       className="text-white font-semibold transition-all duration-200 hover:text-white focus:text-white"> YouTube</a>
                                </li>
                                <li>
                                    <a href="#" title=""
                                       className="text-white font-semibold transition-all duration-200 hover:text-white focus:text-white"> Tik Tok </a>
                                </li>
                                <li>
                                    <a href="#" title=""
                                       className="text-white font-semibold transition-all duration-200 hover:text-white focus:text-white"> Instagram </a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="mt-8 space-y-4">
                                ...
                                <li>
                                    <a href="#" title=""
                                       className="text-white font-semibold transition-all duration-200 hover:text-white focus:text-white"> Delivery Details </a>
                                </li>
                                <li>
                                    <a href="#" title=""
                                       className="text-white font-semibold transition-all duration-200 hover:text-white focus:text-white"> Terms & Conditions </a>
                                ...
                                <li>
                                    <a href="#" title=""
                                       className="text-white font-semibold transition-all duration-200 hover:text-white focus:text-white"> Privacy Policy </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="mt-20 md:mt-28 2xl:mt-32">
                        <div className="lg:flex lg:items-center lg:justify-between">
                            <div className="sm:flex sm:items-center sm:justify-start sm:space-x-8">
                                ...
                                {/*    <li>*/}
                                {/*        <a href="#" title=""*/}
                                {/*           className="block text-white font-semibold transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80">*/}
