  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 p-1 transition-colors duration-300 ${
        isScrolled ? "bg-white bg-opacity-80 text-black" : "bg-black bg-opacity-70 text-white"
      }`}
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className={`hidden lg:flex space-x-6`}>
          ...
          <a href="#offers" className="hover:text-gray-200">Offers</a>
        </div>
        ...
        <div className={`hidden lg:flex space-x-6 items-center`}>
          <a href="#experiences" className="hover:text-gray-200">Experiences</a>
